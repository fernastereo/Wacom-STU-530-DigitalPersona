...
Public Class FrmFirmaCaptura
    ...
    Public Sub New(ByVal usbDevice As wgssSTU.IUsbDevice)
        ...
        Dim font As Font = New Font(FontFamily.GenericSansSerif, 90 / 2.0!, GraphicsUnit.Pixel)
        ...
        ' Draw the buttons
        Dim iFile As String = System.Environment.CurrentDirectory & "\" & "01.jpg"
        ...
        If usbDevices.Count <> 0 Then
            ...
            autorizaNotificacion(usbDevice2)
    ...
    Private Sub FrmFirmaCaptura_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        If usbDevices.Count <> 0 Then
            Try
                ...
                Dim Formulario As New FrmFirmaCaptura_Datos(usbDevice)
                Formulario.ShowDialog()
    ...
    Private Sub FrmFirmaCaptura_MouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseClick
    ...
    Private Sub FrmFirmaCaptura_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Me.Paint
        If (m_penData.Count <> 0) Then
    ...
    Public Sub autorizaNotificacion(ByVal usbDevice As wgssSTU.IUsbDevice)
        Me.AutoScaleDimensions = New System.Drawing.SizeF(96.0!, 96.0!)
        Me.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Dpi
        ...
        End If
        m_btns(0).Text = "No Autorizo"
        m_btns(1).Text = "Autorizo"
        m_btns(0).Click = AddressOf Me.btnCancel_Click
        ...
        Dim i As Integer
        '****
        Dim iFile As String = System.Environment.CurrentDirectory & "\" & "02.jpg"
        Dim m_image As Image = Image.FromFile(iFile)
        gfx.DrawImage(m_image, 0, 0)
        '****
        For i = 0 To m_btns.Length - 1
    ...
    Private Sub FrmFirmaCaptura_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
